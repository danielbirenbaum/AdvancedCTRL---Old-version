...
Nova versão do projeto, **ainda em alpha**. Com essa atualização foi melhorado o design da aplicação e sua estruturação inicial, dividido em duas colunas principais. Uma para a navegação lateral e outra para a homepage inicial
